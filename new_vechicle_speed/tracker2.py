...
#file = open("D://new_vechicle_speed//speed_record.txt","w")
file = open("D://Projects To Put On Git//new_vechicle_speed//speed_record.txt","w")
file.write("ID \t SPEED\n------\t-------\n")
file.close()
...
class EuclideanDistTracker:
    ...
    def update(self, objects_rect):
        ...
        for rect in objects_rect:
            ...
            for id, pt in self.center_points.items():
                ...
                #if pixel1 - pixel2 < 70 => same object
                if dist < 70:
    ...
    def capture(self,img,x,y,h,w,sp,id):
        if(self.capf[id]==0):
            ...
            file = 'D://new_vechicle_speed' + n + '.jpg'
            cv2.imwrite(file, crop_img)
            self.count += 1
            filet = open("D://new_vechicle_speed//speed_record.txt", "a")
            if(sp>limit):
                file2 = 'D://new_vechicle_speed//exceeded_speed//' + n + '.jpg'
    ...
    #TEXT FILE SUMMARY
    def end(self):
        file = open("D://new_vechicle_speed//speed_record.txt", "a")
        file.write("\n-------------\n")
        file.write("-------------\n")
        file.write("SUMMARY\n")
        file.write("-------------\n")
